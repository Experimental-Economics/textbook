##################################################################################################
                        README — Exhibit 12.1.1A (Chapter 12)
                    ATEs With and Without Available Case Analysis
##################################################################################################

This folder contains code to recreate Exhibit 12.1.1A from Chapter 12. The scripts compare
treatment effects with and without available case analysis using CHECC data.
...
##################################################################################################
  ...
  Output:
    - output/Exhibit_12_1_1A_stata.tex   (LaTeX table)
